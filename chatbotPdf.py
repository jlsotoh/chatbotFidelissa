...
st.html(
    "<div style='display: flex; justify-content: space-between;'><div><h1>Chat Modelos de Venta</h1><span>Puedes realizarme preguntas relacionadas a los materiales existentes</span></div><div><img width='130' src='https://ideeo.mx/bbva/chatbot/img/chat.png'></div></div>"
)
